...
<div class="datamahasiswa">
    ...
    <form method="GET" action="">
        <select name="search_id">
            ...
            <option value="nid">NID Dosen</option>
        ...
        <a href="adddosen.php" style="margin-left: 10px;"><button type="button" class="tambah-data-btn">Add New</button>
</a>
        </a>
    </form>
    ...
    <table border="1">
        ...
        $No = 1;
        $query = "SELECT * FROM dosen WHERE 1=1";
        ...
        while ($tampil = mysqli_fetch_array($ambildata)) {
            echo "<tr>
                ...
                <td>" . $tampil['alamat'] . "</td>
                <td>" . $tampil['no_hp'] . "</td>
                <td><button><a href='editdosen.php?id=" . $tampil['id'] . "'>Edit</a></button></td>
                <td><button><a href='databasedosen.php?id=" . $tampil['id'] . "' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?')\">Hapus</a></button></td>
            </tr>";
        }
        ?>
    </table>
    ...
    if (isset($_GET['id'])) {
        ...
        mysqli_query($con, "DELETE FROM dosen WHERE id='$id'");
        echo "Data Berhasil Dihapus";
        echo "<meta http-equiv='refresh' content='2;URL=databasedosen.php'>";
    }
    ?>
</div>
</body>
